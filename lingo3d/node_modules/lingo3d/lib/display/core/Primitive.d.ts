...
declare abstract class Primitive extends ObjectManager<Mesh> implements IPrimitive {
    static defaults: IPrimitive;
    ...
    constructor(geometry: BufferGeometry, transparent?: boolean);
    dispose(): this;
}
