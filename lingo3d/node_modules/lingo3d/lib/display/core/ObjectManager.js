...
export default class ObjectManager extends SimpleObjectManager {
    ...
    find(name) {
        ...
        return child && ((_a = (_b = child.userData).manager) !== null && _a !== void 0 ? _a : (_b.manager = new FoundManager(child)));
    }
    findAll(name) {
        const result = [];
        this.outerObject3d.traverse(child => {
            var _a;
            var _b;
            child.name === name && result.push((_a = (_b = child.userData).manager) !== null && _a !== void 0 ? _a : (_b.manager = new FoundManager(child)));
        });
        return result;
    }
}
