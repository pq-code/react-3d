export default class MeshReflectorMaterial extends MeshStandardMaterial {
    constructor(renderer: any, camera: any, scene: any, object: any, { mixBlur, mixStrength, resolution, blur, minDepthThreshold, maxDepthThreshold, depthScale, depthToBlurRatioBias, mirror, distortion, mixContrast, distortionMap, reflectorOffset, bufferSamples, planeNormal }?: {
        ...
        bufferSamples?: number | undefined;
    ...
    setupBuffers(resolution: any, blur: any, bufferSamples: any): void;
