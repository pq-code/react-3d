import { LinearEncoding, LinearToneMapping, NoToneMapping, sRGBEncoding } from "three";
...
queueMicrotask(() => {
    if (!settings.autoMount || rootContainer.parentElement)
        return;
...
createEffect(() => {
    var _a;
    const [vw, vh] = (_a = getViewportSize()) !== null && _a !== void 0 ? _a : getResolution();
