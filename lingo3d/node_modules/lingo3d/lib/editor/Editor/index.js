...
const addInputs = (pane, title, target, params = { ...target }, vectorMap) => {
    ...
    for (const [key, value] of Object.entries(params))
        switch (typeof value) {
            ...
            case "object":
                ...
                typeof (value === null || value === void 0 ? void 0 : value.x) === "number" && (value.x = toFixed(value.x));
                typeof (value === null || value === void 0 ? void 0 : value.y) === "number" && (value.y = toFixed(value.y));
                typeof (value === null || value === void 0 ? void 0 : value.z) === "number" && (value.z = toFixed(value.z));
                break;
        }
    return Object.fromEntries(Object.keys(params).map(key => {
        ...
        input.on("change", ({ value }) => {
            if (programmatic)
                return;
            if (vectorMap === null || vectorMap === void 0 ? void 0 : vectorMap[key]) {
...
const Editor = ({ mouse, keyboard }) => {
    ...
    useLayoutEffect(() => {
        ...
        if (!pane || !cameraFolder)
            return;
        const options = cameraList.reduce((acc, _, i) => (acc["camera " + i] = i, acc), {});
        ...
        const secondaryOptions = { none: 0, ...omit(options, "camera 0") };
        const secondaryCameraInput = pane.addInput({ "secondary camera": cameraList.indexOf((_a = getSecondaryCamera()) !== null && _a !== void 0 ? _a : mainCamera) }, "secondary camera", { options: secondaryOptions });
    ...
    useEffect(() => {
        ...
        if (!selectionTarget) {
            const omitted = ["defaultFog", "defaultLight", "defaultLightScale"];
            const { defaultLightEnabled: defaultLightEnabledInput, defaultFogEnabled: defaultFogEnabledInput } = addInputs(pane, "settings", settings, Object.assign({
                defaultLightEnabled,
        ...
        const makeVectorNames = (prop) => [prop + "X", prop + "Y", prop + "Z"];
        ...
        if (!multipleSelectionTargets.length) {
            ...
            for (const [key, value] of Object.entries(schema)) {
                if (key in objectManagerSchema || value === Function)
                    continue;
                let v = target[key];
                if (v === Infinity)
                    v = 9999;
