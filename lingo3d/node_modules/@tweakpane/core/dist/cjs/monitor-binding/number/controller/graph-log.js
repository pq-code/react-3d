...
var graph_cursor_1 = require("../model/graph-cursor");
...
var GraphLogController = /** @class */ (function () {
    ...
    GraphLogController.prototype.onGraphMouseMove_ = function (ev) {
        ...
        this.cursor_.index = Math.floor((0, number_util_1.mapRange)(ev.offsetX, 0, bounds.width, 0, this.value.rawValue.length));
    };
    ...
    GraphLogController.prototype.onGraphPointerMove_ = function (ev) {
        ...
        this.cursor_.index = Math.floor((0, number_util_1.mapRange)(ev.data.point.x, 0, ev.data.bounds.width, 0, this.value.rawValue.length));
    };
