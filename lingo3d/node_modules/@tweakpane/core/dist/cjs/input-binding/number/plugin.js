...
function createRangeConstraint(params) {
    if (('max' in params && !(0, type_util_1.isEmpty)(params.max)) ||
        ('min' in params && !(0, type_util_1.isEmpty)(params.min))) {
...
function findRange(constraint) {
    var c = constraint ? (0, composite_1.findConstraint)(constraint, range_1.RangeConstraint) : null;
    if (!c) {
...
exports.NumberInputPlugin = {
    ...
    controller: function (args) {
        ...
        var formatter = (_b = ('format' in args.params ? args.params.format : undefined)) !== null && _b !== void 0 ? _b : (0, number_1.createNumberFormatter)((0, util_1.getSuitableDecimalDigits)(c, value.rawValue));
        if (c && (0, composite_1.findConstraint)(c, range_1.RangeConstraint)) {
